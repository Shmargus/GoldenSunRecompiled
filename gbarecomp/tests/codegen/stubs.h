...
using OverlayResolveFn = void (*)(void);
...
extern unsigned g_static_ram_calls;

// Optional Stage-2 resolver result used by RAM-dispatch regression tests.
// The L1 harness keeps this null unless a test explicitly exercises the
// resolver-fallback ordering.
extern OverlayResolveFn g_overlay_resolve_fn;
